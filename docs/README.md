...
1. `d3d11/READONLY_PIPELINE.md`  
   D3D11 ReadOnly pipeline、FramePool、中央timestamp同期、runtime output、readbackを定義する。
...
3. `design/03_D3D11Backend.md`  
   既存D3D11 backendとlegacy APIの背景資料。
4. `design/13_ReadbackAndCpuFrame.md`  
