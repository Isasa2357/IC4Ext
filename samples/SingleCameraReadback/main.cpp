...
int main(int argc, char** argv)
{
    ...
    const std::filesystem::path outPath = ArgValue(argc, argv, "--out") ? ArgValue(argc, argv, "--out") : (cpuFormat == IC4Ext::CpuFrameFormat::Gray8 ? "frame.pgm" : "frame.ppm");
    ...
    if (!readback.initialize(core->GetDevice(), core->GetImmediateContext())) {
